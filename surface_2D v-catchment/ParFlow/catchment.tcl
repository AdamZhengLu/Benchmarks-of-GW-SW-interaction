...
pfset Geom.domain.Upper.X                        1620.0
...
pfset Geom.left.Upper.X                        800.0
pfset Geom.left.Upper.Y                        1000.0
pfset Geom.left.Upper.Z                          0.5

#---------------------------------------------------------
# Right Slope Geometry 
#---------------------------------------------------------

pfset Geom.right.Lower.X                        820.0
pfset Geom.right.Lower.Y                        0.0
pfset Geom.right.Lower.Z                        0.0
 
pfset Geom.right.Upper.X                        1620.0
pfset Geom.right.Upper.Y                        1000.0
pfset Geom.right.Upper.Z                          0.5

#---------------------------------------------------------
# Channel Geometry 
#---------------------------------------------------------
pfset Geom.channel.Lower.X                        800.0
pfset Geom.channel.Lower.Y                        0.0
pfset Geom.channel.Lower.Z                        0.0
 
pfset Geom.channel.Upper.X                        820.0
pfset Geom.channel.Upper.Y                        1000.0
pfset Geom.channel.Upper.Z                          0.5
...
pfset Geom.left.Perm.Value            0


pfset Geom.right.Perm.Type            Constant
pfset Geom.right.Perm.Value           0

pfset Geom.channel.Perm.Type          Constant
pfset Geom.channel.Perm.Value         0
...
pfset TimingInfo.StopTime        180.0
...
pfset Geom.left.Porosity.Value         0.4

pfset Geom.right.Porosity.Type          Constant
pfset Geom.right.Porosity.Value         0.4

pfset Geom.channel.Porosity.Type          Constant
pfset Geom.channel.Porosity.Value         0.4
...
pfset Cycle.rainrec.rain.Length           90
pfset Cycle.rainrec.rec.Length            90
...
pfset Patch.z-upper.BCPressure.rain.Value	      -0.00018
...
pfset TopoSlopesY.Geom.left.Value 	0.02
pfset TopoSlopesY.Geom.right.Value	0.02
pfset TopoSlopesY.Geom.channel.Value 	0.02
...
pfset Mannings.Geom.left.Value 		0.00025
pfset Mannings.Geom.right.Value 	0.00025
pfset Mannings.Geom.channel.Value 	0.0025
